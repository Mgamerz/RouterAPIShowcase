 ...
 * sure they want to reboot the router
 * @author Mike Perez
 */

public class RebootRouterDialogFragment extends DialogFragment {

	/**
	 * This constructor must be empty or the Fragment won't be able to start.
	 */
	public RebootRouterDialogFragment() {
	 ...
	 */
	public static RebootRouterDialogFragment newInstance() {
		RebootRouterDialogFragment dwdf = new RebootRouterDialogFragment();
		return dwdf;
	}
