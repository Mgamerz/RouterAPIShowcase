...
/**
 * Database adapter used in managing router profile information
 * 
...
public class DatabaseAdapter {
	...
	public static final String DATABASE_NAME = "RouterDB";
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			Log.i(CommandCenterActivity.TAG, "Upgrading database from version " + oldVersion + " to " + newVersion + ", which will destroy all old data");
	...
	public void deleteAllProfiles() {
		deleteAllEcmProfiles();
		deleteAllDirectProfiles();
	}
	...
	/**
	 * Gets a list of all profiles stored in the database and returns it as an
	 * arraylist
	 * 
	 * @return Arraylist of all profiles stored in the database, or an empty one
	 *         if there are none.
	 */
